...
export const churchContent = {
  ...
  about: [
    "Церковь Божия города Минеральные Воды — местная религиозная организация христиан веры евангельской.",
    "Мы собираемся вместе для молитвы, поклонения Богу, изучения Священного Писания и общения, стремясь жить в соответствии с Евангелием и служить людям",
    "На этом сайте размещена основная информация о богослужениях, мероприятиях, контактах и жизни церкви.",
  ],
  faith: {
    intro:
